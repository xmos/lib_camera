...
def create_fir_filter(taps=3, factor=2, aux=5):
...
if __name__ == '__main__':
    ...
    v_filter    =  create_fir_filter(TAPS_V, 2)
    h_filter    =  create_fir_filter(TAPS_H, 2)
    
    #v_filter    =  create_gaussian_filter(TAPS_V, sigma)
    #h_filter    =  create_gaussian_filter(TAPS_H, sigma)
