...
def decode_greyscaled_image(input_name="capture.bin", width=160, height=120, img_dtype="uint8", plot=True):
    # read the data
...
if __name__ == "__main__":
    ...
    decode_greyscaled_image(args.input, args.width, args.height, args.dtype)
    print("done")
