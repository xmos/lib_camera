...
void camera_isp_raw8_to_rgb2(image_cfg_t* image, int8_t* data_in, unsigned sensor_ln){
    ...
    // 4 rows of MODE_RGB2_MAX_SIZE pixels
    static int8_t input_rows[4][MODE_RGB2_MAX_SIZE] ALIGNED_8 = { {0} };
